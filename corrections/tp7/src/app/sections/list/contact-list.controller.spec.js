...
describe('controller: ContactListController', function() {
    ...
    //     };
    //
    //     it('should have a list of all contacts', inject(function($rootScope, $q, $controller) {
    //         var scope = $rootScope.$new();
    //         var response = { data: contacts };
    //         spyOn(ContactServiceMock, 'getAllContacts').and.returnValue($q.when(response));
    //         var controller = $controller('ContactListController', { ContactService: ContactServiceMock });
    //         scope.$digest();
